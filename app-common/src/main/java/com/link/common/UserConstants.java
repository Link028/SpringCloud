...
public class UserConstants
{
	public static void main(String[] args) {
		byte[]  bts = FileUtil.readFile("H:\\workspaceweb\\app-web\\public\\img\\user\\fmale.jpg") ;
		String str = java.util.Base64.getEncoder().encodeToString(bts);
	...
	/** 用户删除状态 */
	public static final String USER_DELETED = "0";
